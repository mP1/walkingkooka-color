...
/**
 * A {@link HsvColorComponent} base class for saturation and value.
 */
abstract class AlphaSaturationOrValueHsvColorComponent extends HsvColorComponent {
     ...
     */
    AlphaSaturationOrValueHsvColorComponent(final float value) {
        super(value);
    }

    @Override
    public final HsvColorComponent invert() {
        return this.setValue(MAX_VALUE - this.value);
    }
