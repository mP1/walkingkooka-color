...
abstract public class HslColorComponentTestCase<C extends HslColorComponent> extends HslOrHsvColorComponentTestCase<C> {

    HslColorComponentTestCase() {
        super();
    }
    ...
    public final void testSet() {
        ...
        final HslColorComponent component = original.setValue(value);
    ...
    private void addAndCheck(final float initial, final float delta, final float expected) {
        ...
        final HslColorComponent added = component.add(delta);
    ...
    public final void testIsMethods() throws Exception {
        ...
        final String isMethodName = "is" + CharSequences.capitalize(name.substring(0, name.length() - "HslColorComponent".length()));
    ...
    public final String toIsMethodName(final String typeName) {
        return this.toIsMethodNameWithPrefixSuffix(
            typeName,
            "",
            HslColorComponent.class.getSimpleName()
        );
    }
    ...
    public final String typeNameSuffix() {
        return HslColorComponent.class.getSimpleName();
    }
