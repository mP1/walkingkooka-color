...
abstract public class HsvColorComponentTestCase<C extends HsvColorComponent> extends HslOrHsvColorComponentTestCase<C> {

    HsvColorComponentTestCase() {
        super();
    }
    ...
    public final void testSet() {
        ...
        final HsvColorComponent component = original.setValue(value);
    ...
    private void addAndCheck(final float initial, final float delta, final float expected) {
        ...
        final HsvColorComponent added = component.add(delta);
